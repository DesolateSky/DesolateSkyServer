...
//    private final BlockSettings blockSettings;
    ...
    public <T extends ItemBehavior> Optional<T> getBehavior(ItemBehavior.Type<T> behaviorType) {
        ...
        return Optional.of(behaviorType.itemBehaviorClass().cast(blockBehavior));
    }
