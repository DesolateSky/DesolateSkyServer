...
import com.fisherl.desolatesky.config.ConfigFile;
import com.fisherl.desolatesky.config.ConfigUtil;
import com.fisherl.desolatesky.lock.Lockable;
import com.fisherl.desolatesky.message.impl.ActionBarMessage;
import com.fisherl.desolatesky.message.impl.ChatMessage;
import com.fisherl.desolatesky.message.impl.TitleMessage;
import com.fisherl.desolatesky.util.TimeUtil;
...
public class MessageHandler implements Lockable {
    ...
    public static MessageHandler create(Path filePath, String resourcePath) {
        final ConfigFile config = ConfigFile.get(filePath, resourcePath, builder -> builder
    ...
    public Message getNonNullMessage(String id) {
        return this.lockRead(() -> this.messages.getOrDefault(id, Message.EMPTY));
    }
