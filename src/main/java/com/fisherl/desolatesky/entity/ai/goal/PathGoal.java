package com.fisherl.desolatesky.entity.ai.goal;

import com.fisherl.desolatesky.entity.DSLivingEntity;
import com.fisherl.desolatesky.island.Island;
import com.fisherl.desolatesky.pathfinding.Pathfinding;
import com.fisherl.desolatesky.pathfinding.WorldPathfindingContext;
...
public final class PathGoal<T extends DSLivingEntity<T>> implements AIGoal {
    ...
    public void tick(long time) {
        ...
        final Vec move = this.currentTarget.sub(this.entity.getPosition()).asVec();
        this.entity.lookAt(this.currentTarget);
        final Vec currentVelocity = this.entity.getVelocity();
        this.entity.setVelocity(currentVelocity.add(move.normalize().mul(this.entity.getAttributeValue(Attribute.MOVEMENT_SPEED))));
    }
