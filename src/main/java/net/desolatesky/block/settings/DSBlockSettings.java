...
public final class DSBlockSettings {
    ...
    public static final BlockSettings OAK_PLANKS = builder(Block.OAK_PLANKS).breakTime(3_000).stateless().blockItem(ItemKeys.OAK_PLANKS).categories(BlockCategories.AXE_MINEABLE).build();
