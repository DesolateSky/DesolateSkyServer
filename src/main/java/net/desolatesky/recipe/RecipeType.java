...
public record RecipeType<I extends RecipeInput, R extends RecipeResult>(Class<I> inputClass, Class<R> resultClass) {
    ...
    public static final RecipeType<CrucibleRecipe.Input, CrucibleRecipe.Result> CRUCIBLE = new RecipeType<>(CrucibleRecipe.Input.class, CrucibleRecipe.Result.class);
